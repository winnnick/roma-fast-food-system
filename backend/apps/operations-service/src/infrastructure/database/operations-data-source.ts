...
import { AddInventoryIntegrationToSales1787047200000 } from './migrations/1787047200000-add-inventory-integration-to-sales';
...
if (!databaseUrl) {
  throw new Error(
    'OPERATIONS_DATABASE_URL es obligatorio para migraciones de Operations. No se permite una URL genérica compartida.',
  );
}
...
export const OperationsDataSource = new DataSource({
  ...
  migrations: [
    CreateCatalogSchema1786788000000,
    CreateSalesCashSchema1786874400000,
    AddInventoryIntegrationToSales1787047200000,
  ],
